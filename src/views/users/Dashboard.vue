    ...
    <div>
        ...
        <div class="container">
            ...
            <div class=" text-center" >
                <div class="row">
                    <div class="card col-sm-10 col-lg-3 ml-5" v-for="artist in artists" :key="artist.artist_id">
        ...
        <div class="container">
            <div class="d-flex justify-content-between m-2">
                <p class="h2 text-center">Recommended For You</p>
                <p style="color: #A10035;">View All</p>
            </div>
            <div class=" text-center">
                <div class="row">
        ...
        <div class="text-center p-4 mt-5 " style="background-color: #FAD9D9;">
            ...
            <button style="background-color: #A10035; border-color: #A10035;" class="btn btn text-light mt-3 fs-3">Find musicians</button>
        </div>
